...
function Page() {
    ...
    const featuredProducts = useProductTabs(
        useMemo(() => [
            { id: 1, name: 'All', nameA: 'All', categorySlug: null },
            { id: 2, name: 'Power Tools', nameA: 'Power Tools', categorySlug: 'power-tools' },
            { id: 3, name: 'Hand Tools', nameA: 'Hand Tools', categorySlug: 'hand-tools' },
            { id: 4, name: 'Plumbing', nameA: 'Plumbing', categorySlug: 'plumbing' },
        ], []),
